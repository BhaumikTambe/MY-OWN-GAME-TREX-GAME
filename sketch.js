...
function setup() {
 ...
 console.log(message)
  ...
  ground = createSprite(200,height-50,100000,20);
  ground.addImage("ground",groundImage);
  ground.x = ground.width /2;
  
  
  gameOver = createSprite(width-700,height-350);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(width-700,height-300);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = Math.round(random(0,height-90));
